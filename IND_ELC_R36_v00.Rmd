...
## Scenario 2a: Exogenous UHV grid 100GW between neighbours (no capacity variable), endogenous converter stations
~ 8h to solve
...
## Scenario 2b: Exogenous ELC grid 100GW between neighbours, fixed capacity
~ 15 min to solve
...
## Scenario 2c: Exogenous grid 100GW between neighbours (no capacity variable) 
~ 11 min GAMS time
